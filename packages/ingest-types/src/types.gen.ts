...
/**
 * Decrypted secret value for the requested provider.
 */
export type ResolveSecretResponse = {
    provider: SecretResolveProvider;
    /**
     * The decrypted plaintext secret for the requested provider.
     */
    secret_value: string;
};
...
export type ResolveSecretResponse2 = ResolveSecretResponses[keyof ResolveSecretResponses];
...
export type AdminDeleteHubWorkflowError = AdminDeleteHubWorkflowErrors[keyof AdminDeleteHubWorkflowErrors];
...
export type AdminDeleteHubWorkflowResponse = AdminDeleteHubWorkflowResponses[keyof AdminDeleteHubWorkflowResponses];
...
export type ReleaseDeletionHoldError = ReleaseDeletionHoldErrors[keyof ReleaseDeletionHoldErrors];
...
export type ReleaseDeletionHoldResponse = ReleaseDeletionHoldResponses[keyof ReleaseDeletionHoldResponses];
...
export type ReportHistoryEventError = ReportHistoryEventErrors[keyof ReportHistoryEventErrors];
...
export type ReportHistoryEventResponse = ReportHistoryEventResponses[keyof ReportHistoryEventResponses];
